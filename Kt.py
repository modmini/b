...
#-----------------------------------------------
                ...
                if msg.to in wait2['readPoint']:
                    ...
                    with open('sider.json', 'w') as fp:
                     json.dump(wait2, fp, sort_keys=True, indent=4)
                     cl.sendText(msg.to, "ตรวดจับคนแอบอ่าน\nSet reading point:\nกรุณาพิม/อ่าน" + datetime.now().strftime('%H:%M:%S'))
                     print wait2
...
#-----------------------------------------------
                        ...
                        cl.sendText(msg.to,"มดตีป้อมอยู่แปปนะ")
            elif msg.text in ["แท๊ก"]:
                        cl.sendText(msg.to,"อย่าเล่นบ่อยเดะตูโดนด่า")
                        cl.sendText(msg.to,"แท๊ก")
#-----------------------------------------------
