...
cl = LINETCR.LINE()
cl.login(token="ErgaxKr6u4z3J0R3pqp1.w2CFquIQw77bHRw3YYLsCq.Ju8xcJi4bDj2aquS5jakt2eM6wGyPFbTgGOoeTTQGp8=")
cl.loginResult()

#ki1 = LINETCR.LINE()
#ki1.login(token="Erkr3Q0g6ZmLhZMuwtFd.eu2rNkSFmmbU2bKKpaVRRq.eBpIintf4acQM+vJld5v5DND980GDF2ENNvhE27FLVw=")
#ki1.loginResult()

#ki2 = LINETCR.LINE()
#ki2.login(token="Erkr3Q0g6ZmLhZMuwtFd.eu2rNkSFmmbU2bKKpaVRRq.eBpIintf4acQM+vJld5v5DND980GDF2ENNvhE27FLVw=")
#ki2.loginResult()

#ki3 = LINETCR.LINE()
#ki3.login(token="Erkr3Q0g6ZmLhZMuwtFd.eu2rNkSFmmbU2bKKpaVRRq.eBpIintf4acQM+vJld5v5DND980GDF2ENNvhE27FLVw=")
#ki3.loginResult()

#ki4 = LINETCR.LINE()
#ki4.login(token="EqSrNnHORz2gCCdJCEHf.L3aPxFfibnJQ/NoW5OJ13W.++uHDaxSgOqqfCXsgH3zT34/HwVmIaGKDMP7iEEowLg=")
#ki4.loginResult()

#ki5 = LINETCR.LINE()
#ki5.login(token="EqNXw5RzATIWnNSaj9Oa.xcKM8Bfyit5Di29joqKJoG.L0sKipSd3mtzecM7BdNMmT9Gpdq8UIRBrXLvK4KztMs=")
#ki5.loginResult()

#ki6 = LINETCR.LINE()
#ki6.login(token="Erkr3Q0g6ZmLhZMuwtFd.eu2rNkSFmmbU2bKKpaVRRq.eBpIintf4acQM+vJld5v5DND980GDF2ENNvhE27FLVw=")
#ki6.loginResult()

#ki7 = LINETCR.LINE()
#ki7.login(token="Erkr3Q0g6ZmLhZMuwtFd.eu2rNkSFmmbU2bKKpaVRRq.eBpIintf4acQM+vJld5v5DND980GDF2ENNvhE27FLVw=")
#ki7.loginResult()

#ki8 = LINETCR.LINE()
#ki8.login(token="Eq4CgaN8NeEaSfKGjXJ5.1fsuVPr1VUsg+aWA0Jacbq.6uZ3aQdprnQ6Sx8wXExi72nkBd+vNxZK4NtlL6sHDHo=")
#ki8.loginResult()

#ki9 = LINETCR.LINE()
#ki9.login(token="Erkr3Q0g6ZmLhZMuwtFd.eu2rNkSFmmbU2bKKpaVRRq.eBpIintf4acQM+vJld5v5DND980GDF2ENNvhE27FLVw=")
#ki9.loginResult()

#ki10 = LINETCR.LINE()
#ki10.login(token="Erkr3Q0g6ZmLhZMuwtFd.eu2rNkSFmmbU2bKKpaVRRq.eBpIintf4acQM+vJld5v5DND980GDF2ENNvhE27FLVw=")
#ki10.loginResult()
...
║  ☮  【ติดต่อสอบถาม】  ☮
╠══════════════
║👉รับติดตั้งบอททุกชนิด👈
║👉รับทำเซลบอททุกรูปแบบ👈
║👉รับเปิดเซิฟไห้เช่า👈
║👉รับทำบอทแท็ก👈
║👉รับทำบอทบิน👈
║👉มีทั้งแบบรายครั่งรายเดือนตามความต้องการ👈
║👉และอื่นๆอีกมากมาย👈
║👉แอดมาคุยกันได้ที่👈
║👉 http://line.me/ti/p/~topbotseft 👈 (ท๊อป)
║👉 http://line.me/ti/p/~antmod. 👈 (มด)
║👉 By'Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს 👈
╚══════════════
✥===========================✥"""
...
║🍁➣『คท』= แสดงคอนแทรกเรา
║🍁➣『ร่าง』= คิกเกอร์ของเรา
║🍁➣『K1 - K10』= เชคคิกเกอร์ที่ละร่าง
║🍁➣『1in - 10in』= สั่งคิกเกอร์เข้าทีละตัว
║🍁➣『K1 bye - K10 bye』= สั่งคิกเกอร์ออกทีละร่าง
║🍁➣『ไอดี』=  แสดงไอดีเรา
║ ➣『ตัส』= เช็คตัสเรา
║ ➣『รูป』= แสดงรูปเรา
║🍁➣『เชิญ』= ดึงคนด้วยคท
...
║🍁➣『ลบรัน8』= ลบห้องรันคิ8
║🍁➣『ลบรัน9』= ลบห้องรันคิ9
║🍁➣『ลบรัน10』= ลบห้องรันคิ10
║🍁➣『รัน @』= รันแชตคน (ใช้ได้วันละ10ครั่ง)
║🍁➣『ฝันดี @』= รันแชตบอกฝันดี (ใช้ได้วันละ10ครั่ง)
║🍁➣『มอนิ่ง @』= รันแชตบอกมอนิ่ง (ใช้ได้วันละ10ครั่ง)
║ ➣『รักนะ @』= รันแชตบอกรัก (ใช้ได้วันละ10ครั่ง)
║🍁➣『ชื่อ 』= แสดงชื่อเรา
║🍁➣『ลบแชต』= ลบแชตเราทั้งหมด
║🍁➣『รีบูต』= รีบูทไห้เซลทำงาน
║🍁➣『Gn: text 』= เปลี่ยนชื่อกลุ่ม
║🍁➣『ใครแอบ』= เชคคนแอบอ่าน
║🍁➣『ออกมา』= เชคคนอ่าน 
║ ➣『ยึด』= ขโมยรูป
║ ➣『รูป』= แสดงรูปเรา
║ ➣『บ้าน』= เชคกลุ่มทั้งหมด
║ ➣『เลิกแกล้ง @』= ล้างคนติดดำ
║ ➣『ไอดีกลุ่ม』= แสดงไอดีของกลุ่ม
║ ➣『ชื่อฉัน』= แสดงชื่อตัวเอง
║ ➣『วีดีโอ』= แสดงโปรแบบวีดีโอ
║ ➣『ลิ้งรูป』= แสดงรูปแบบลิ้ง
║ ➣『โปรทั่งกลุ่ม』= ขโมยรูปคนทั้งกลุ่ม 
║ ➣『#รูปกลุ่ม』= ขโมยรูปกลุ่ม
║ ➣『ดูดำ』= ดูว่ามีคนติดดำอยู่ในกลุ่มนี้ไหม 
║ ➣『แผนที่ 』= แสดงแผนที่
...
║🍁➣『เทส』= เชคบอท
║🍁➣『Myginfo』
║🍁➣『ทีมงาน』= กรณีบอทมีปัญหาแจ้ง
║🍁➣『โปรวีดีโอ @』= ขโมยโปรแบบวีดีโอ
║🍁➣『ลิ้งโป』= ขโมยโปรแบบลิ้ง
║🍁➣『Tr-th 』= แปลงคำพูดเป็นภาษาไทย
║🍁➣『Tr-en 』= แปลงคำพูดเป็นภาษาอังกฤ
║ ➣『Tr-id』= แปลคำพูดเป็นภาษาอินโด 
║🍁➣『Gurl』
║🍁➣『คิลิ้ง』= สั่งคิเปิดลิ้ง
║🍁➣『Glist』
║🍁➣『ยูทูป 』= เปิดยูทูป
║🍁➣『Mod tag』=แท็กสมาชิคในห้อง
║🍁➣『Gcancel:』=กันเชิญจำนวนห้อง:
║🍁➣『รูปมา 』 = จะมีรูปขึ้นตามมี่เราพิม
║🍁➣『ใครซน』= ดูว่าใครติดแบน
...
targets = []
mid = cl.getProfile().mid
Bots = ["u114d919cab1f30c06ed819243c0bebad",mid]
self = ["u114d919cab1f30c06ed819243c0bebad",mid]
admin = "u114d919cab1f30c06ed819243c0bebad"
admsa = "u114d919cab1f30c06ed819243c0bebad"
owner = "u114d919cab1f30c06ed819243c0bebad"
adminMID = "u114d919cab1f30c06ed819243c0bebad"
Creator= "u114d919cab1f30c06ed819243c0bebad"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,helpt)
            elif msg.text in ["การใช้งาน","วิธีใช้","Cmd"]:
                print "\nHelp pick up..."
                if wait["lang"] == "JP":
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        ki1.sendText(msg.to,"[Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს]")
...
ในแบบ ฉบับของ พวกเรา..Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს
──────┅═ই۝ई═┅──────
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
""")
...
""")
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    cl.sendText(msg.to,"😏")
            elif "เหงา" in msg.text:
                       nk0 = msg.text.replace("เหงา","")
                       nk1 = nk0.lstrip()
                       nk2 = nk1.replace("","")
                       nk3 = nk2.rstrip()
                       _name = nk3
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    cl.sendText(msg.to,"😂")
            elif "เท่" in msg.text:
                       nk0 = msg.text.replace("เท่","")
                       nk1 = nk0.lstrip()
                       nk2 = nk1.replace("","")
                       nk3 = nk2.rstrip()
                       _name = nk3
                ...
                ki1.sendText(msg.to,"ยังอยู่ 😎􀜁􀅔")                
...
#-----------------------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       ...
                       cl.sendText(g.mid,"Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს")
                       cl.sendText(g.mid,"Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს")
                       cl.sendText(g.mid,"Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს")
                       cl.sendText(g.mid,"Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს")
                       cl.sendText(g.mid,"Ŧ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს")
                       ...
                       print "Done spam"
#----------------------------------------------------------
            elif "ฝันดี @" in msg.text:
                _name = msg.text.replace("ฝันดี @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(msg.to,"เริ่มทำการบอกฝันดี")
                       cl.sendText(g.mid,"ฝันดีนะ")
                       cl.sendText(g.mid,"ฝันดีนะ")
                       cl.sendText(g.mid,"ฝันดีนะ")
                       cl.sendText(g.mid,"ฝันดีนะ")
                       cl.sendText(g.mid,"ฝันดีนะ")
                       ...
                       cl.sendText(g.mid,"ฝันดีนะ")
                       cl.sendText(g.mid,"ฝันดีนะ")
                       cl.sendText(msg.to, "ทำการบอกฝันดีเรียบร้อย")
                       print "Done spam"
#----------------------------------------------------------
            elif "มอนิ่ง @" in msg.text:
                _name = msg.text.replace("มอนิ่ง @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(msg.to,"เริ่มทำการบอกมอนิ่ง")
                       cl.sendText(g.mid,"มอนิ่ง")
                       cl.sendText(g.mid,"มอนิ่ง")
                       cl.sendText(g.mid,"มอนิ่ง")
                       cl.sendText(g.mid,"มอนิ่ง")
                       cl.sendText(g.mid,"มอนิ่ง")
                       ...
                       cl.sendText(g.mid,"มอนิ่ง")
                       cl.sendText(g.mid,"มอนิ่ง")
                       cl.sendText(msg.to, "ทำการบอกมอนิ่งเรียบร้อย")
                       print "Done spam"
#----------------------------------------------------------
            elif "รักนะ @" in msg.text:
                _name = msg.text.replace("รักนะ @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(msg.to,"เริ่มทำการบอกรัก")
                       cl.sendText(g.mid,"รักนะ💕")
                       cl.sendText(g.mid,"รักนะ💕")
                       cl.sendText(g.mid,"รักนะ💕")
                       cl.sendText(g.mid,"รักนะ💕")
                       cl.sendText(g.mid,"รักนะ💕")
                       ...
                       cl.sendText(g.mid,"รักนะ💕")
                       cl.sendText(g.mid,"รักนะ💕")
                       cl.sendText(msg.to, "ทำการบอกรักเรียบร้อย")
                       print "Done spam"
#----------------------------------------------------------
            elif msg.text in ["รีบูต"]:
                cl.sendText(msg.to,"┣▇▇10%▇▇═─")
                cl.sendText(msg.to,"┣▇▇20%▇▇═─")
                cl.sendText(msg.to,"┣▇▇30%▇▇═─")
                cl.sendText(msg.to,"┣▇▇40%▇▇═─")
                cl.sendText(msg.to,"┣▇▇50%▇▇═─")
                cl.sendText(msg.to,"┣▇▇60%▇▇═─")
                cl.sendText(msg.to,"┣▇▇70%▇▇═─")
                cl.sendText(msg.to,"┣▇▇80%▇▇═─")
                cl.sendText(msg.to,"┣▇▇90%▇▇═─")
                cl.sendText(msg.to,"┣▇▇99%▇▇═─")
                cl.sendText(msg.to,"┣▇▇100%▇▇═─")
                cl.sendText(msg.to,"●ทำการรีบูตบอทแล้ว●")
#----------------------------------------------------------
#========================================
...
#========================================
            ...
            elif "รูปมา " in msg.text:
                bahasa_awal = 'id'
                bahasa_tujuan = 'id'
                kata = msg.text.replace("รูปมา ","")
...
#========================================
                ...
                try:
                    ...
                    cl.sendText(msg.to,(error))
                    pass
            elif "ยึด " in msg.text:
                if msg.toType == 2:
                    msg.contentType = 0
                    steal0 = msg.text.replace("ยึด ","")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"อยู่เฉยๆอย่าขยับเดี๋ยวจุก")
                            except:
                                cl.sendText(msg.to,"Error")
            elif "เลิกแกล้ง @" in msg.text:
                if msg.toType == 2:
                    print "[WL]ok"
                    _name = msg.text.replace("เลิกแกล้ง @","")
                    _nametarget = _name.rstrip('  ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"เคๆไม่แกล้งละอย่าดื้ออีกนะ")
                            except:
                                cl.sendText(msg.to,"เคๆแก้ไห้ละอย่าดื้ออีกละ")
            elif msg.text in ["Clear ban","ล้างดำ"]:
				wait["blacklist"] = {}
				cl.sendText(msg.to,"หมดเวณกรรมแล้ว")
...
#==============================================================================#
                ...
                if len(string.decode('utf-8')) <= 10000000000:
                    ...
                    cl.updateProfile(profile)
                    cl.sendText(msg.to,"Changed " + string)
            elif msg.text in ["ชื่อฉัน","Mename"]:
                    h = cl.getContact(mid)
                    cl.sendText(msg.to,"===[DisplayName]===\n" + h.displayName)
                ...
                try:
                    ...
                    pass
            elif "โปรทั่งกลุ่ม" in msg.text:
                       nk0 = msg.text.replace("โปรทั่งกลุ่ม","")
                       nk1 = nk0.lstrip()
                       nk2 = nk1.replace("","")
                       nk3 = nk2.rstrip()
                       _name = nk3
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    raise e
            elif "โปรวีดีโอ @" in msg.text:
                print "[Command]dp executing"
                _name = msg.text.replace("โปรวีดีโอ @","")
                _nametarget = _name.rstrip('  ')
                gs = cl.getGroup(msg.to)
                targets = []
                for g in gs.members:
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ...
                               cl.sendText(msg.to, "บินเสร็จจะคืน")
                            except Exception as e:
                                print e
...
#==============================================================================#
                    ...
                    cl.sendText(msg.to, botKernel + "\n\n===SERVER INFO CPU===")
            elif msg.text in ["Pmcheck","เชคดำ","คนซน"]:   
                if wait["blacklist"] == {}:
                    cl.sendText(msg.to,"ไม่พบคนซน")
                else:
                    cl.sendText(msg.to,"รายชื่อคนซน")
                    num=1
                    msgs="══════════ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ═════════"
                    for mi_d in wait["blacklist"]:
                        msgs+="\n[%i] %s" % (num, cl.getContact(mi_d).displayName)
                        num=(num+1)
                    msgs+="\n══════════ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ═════════\n\nTotal Blacklist : %i" % len(wait["blacklist"])
                    cl.sendText(msg.to, msgs)
            elif msg.text in ["Mcheckcontact","ใครซน"]:
                if wait["blacklist"] == {}:
                    cl.sendText(msg.to,"ไม่พบคนซน")
                else:
                    cl.sendText(msg.to,"คอนแทกคนซน")
                    h = ""
...
#=============================================
                ...
                start = time.time()
                cl.sendText(msg.to, "ความเสถียนตอนนี้....")
                elapsed_time = time.time() - start
...
# ----------------- BAN MEMBER BY TAG 2TAG ATAU 10TAG MEMBER
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                if wait["blacklist"] == {}:
                    cl.sendText(msg.to,"ไม่มีคนติดดำในกลุ่มนี้")
                else:
...
#                    cl.sendMessage(msg)
                ...
                cl.sendText(msg.to,X)
                    ...
                    with requests.session() as s:
                        ...
                        G.preventJoinByTicket(G)
                        ki10.updateGroup(G)
            elif 'แผนที่ ' in msg.text.lower():
                  try:
                      wiki = msg.text.lower().replace("แผนที่ ","")
                      wikipedia.set_lang("th")
                      pesan="Wikipedia : "
                      pesan+=wikipedia.page(wiki).title
                      pesan+="\n\n"
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                print ("Auto Like 🔥ᴛᴇᴀᴍᴍᴏᴅᴅᴀʀᴋsᴇʟғʙᴏᴛ🔥")
